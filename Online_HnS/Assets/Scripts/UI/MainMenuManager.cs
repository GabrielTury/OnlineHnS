...
public class MainMenuManager : MonoBehaviour
{
    ...
    {
        StartCoroutine(UIUtils.MoveOverSecondsRectTransform(gameLogo, new Vector3(0, 300, 0), 1f));
        StartCoroutine(UIUtils.ScaleOverSecondsRectTransform(gameLogo, new Vector3(0.4f, 0.4f, 0.4f), 1f));
    }
